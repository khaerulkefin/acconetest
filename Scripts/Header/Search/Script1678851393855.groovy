...
WebUI.setText(findTestObject('Object Repository/Navbar/Search/input_Search'), keyword)
...
for (def dataCard : cardSearch) {
    listSearch.add(dataCard.getText().toLowerCase())
}

for (int i = 0; i < listSearch.size(); i++) {
    if (listSearch.get(i).contains(keyword)) {
